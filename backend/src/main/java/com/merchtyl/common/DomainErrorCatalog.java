...
final class DomainErrorCatalog {
    private static final Map<String, Entry> ERRORS = Map.ofEntries(
            ...
            entry("REGISTER_ALREADY_OPEN", "This register is currently open in another session. Choose another register or ask a manager for assistance."),
            entry("REGISTER_SESSION_OWNED_BY_ANOTHER_USER", "This register session belongs to another operator."),
            ...
            entry("BUSINESS_DAY_HAS_UNFINALIZED_SALES", "Complete, cancel, or resolve all unfinished checkouts and held sales before closing the business day."),
            ...
            entry("UNFINISHED_CHECKOUT", "Cancel or complete the unfinished checkout before closing the business day."),
            entry("UNFINISHED_PAID_CHECKOUT", "This unfinished checkout has recorded payments and must be reviewed before closing the business day."),
            ...
            entry("SYSTEM_CATEGORY_PROTECTED", "This system category is required and cannot be renamed or deactivated."),
            entry("LOTTERY_CATEGORY_NOT_CONFIGURED", "The required Lottery product category is not configured for this merchant."),
            ...
            entry("PRICING_PLAN_VERSION_CONFLICT", "A pricing change already exists for this effective date. Cancel the existing scheduled change or choose a different date."),
            entry("PRICING_PLAN_VERSION_NOT_CANCELLABLE", "Only a scheduled pricing change can be cancelled. This version is already active, superseded, or cancelled."),
            entry("PRICING_PLAN_VERSION_STATE_CHANGED", "This pricing version changed while the request was being processed. Refresh pricing history and try again."),
            entry("PRICING_PLAN_EFFECTIVE_DATE_INVALID", "Choose today or a future effective date. Past dates cannot be used because completed billing periods are not recalculated."),
            entry("PRICING_PLAN_MODIFIED", "This pricing plan was updated by someone else. Refresh it before scheduling another change."),
