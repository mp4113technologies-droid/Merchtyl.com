...
public class FoodMenuController {
    ...
    @GetMapping("/choice-groups") @PreAuthorize(VIEW) List<ChoiceGroupResponse> choiceGroups(@PathVariable UUID storeId,Authentication auth){return service.choiceGroups(storeId,auth);}
    @PostMapping("/choice-groups") @ResponseStatus(HttpStatus.CREATED) @PreAuthorize(MANAGE) ChoiceGroupResponse createChoiceGroup(@PathVariable UUID storeId,@Valid @RequestBody ChoiceGroupRequest request,Authentication auth){return service.createChoiceGroup(storeId,request,auth);}
    @PutMapping("/choice-groups/{id}") @PreAuthorize(MANAGE) ChoiceGroupResponse updateChoiceGroup(@PathVariable UUID storeId,@PathVariable UUID id,@Valid @RequestBody ChoiceGroupRequest request,Authentication auth){return service.updateChoiceGroup(storeId,id,request,auth);}
