...
public class InitialInventoryImportRow extends BaseUuidEntity {
    ...
    public InitialInventoryImportRow(int rowNumber,String productReference,String productName,String variantName,String barcode,String sku,BigDecimal sellingPrice,BigDecimal costPrice,BigDecimal openingQuantity,BigDecimal lowStockLevel,String category,String brand,String unitCode,String taxCategory,String supplier,boolean ageRestricted,boolean active,String productAction,String variantAction,UUID productId,UUID variantId,List<String> errors){this.rowNumber=rowNumber;this.productReference=productReference;this.productName=productName;this.variantName=variantName;this.barcode=barcode;this.sku=sku;this.sellingPrice=sellingPrice;this.costPrice=costPrice;this.openingQuantity=openingQuantity;this.lowStockLevel=lowStockLevel;this.category=category;this.brand=brand;this.unitCode=unitCode;this.taxCategory=taxCategory;this.supplier=supplier;this.ageRestricted=ageRestricted;this.active=active;this.productAction=productAction;this.variantAction=variantAction;this.productId=productId;this.variantId=variantId;this.errorCodes=String.join(",",errors);initializeIdAndTimestamps();}
