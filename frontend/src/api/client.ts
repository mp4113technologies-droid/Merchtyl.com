...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  BUSINESS_DAY_RECONCILIATION_INCOMPLETE: 'Complete register reconciliation before closing the business day.',
  BUSINESS_DAY_STATE_CHANGED: 'The business day changed. Refresh the page and try again.',
  VARIANCE_EXPLANATION_REQUIRED: 'Please explain the cash variance before closing.',
